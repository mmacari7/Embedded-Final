...
int main(void){
  ...
  //SysTick_Init(2666666); //Initialize SysTick with 30 Hz interrupts
	SysTick_Init(20000000); //Increased period by 4 for actual hardware to make the game run at a playable speed
